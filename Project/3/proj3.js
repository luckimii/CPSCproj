...
function Piece(row, col, color) {
    ...
    this.isValidMove = function (newRow, newCol) {
        ...
        if ((this.color == "red" || this.isKing) && (newRow == this.row + 1) &&
            (newCol == this.col + 1 || newCol == this.col - 1)) {
            return true;
        }

        if ((this.color == "grey" || this.isKing) && (newRow == this.row - 1) &&
            (newCol == this.col + 1 || newCol == this.col - 1)) {
            return true;
        }


        if ((this.color == "red" || this.isKing) && newRow == this.row + 2 &&
        ...
        if (this.color == "grey" || this.isKing) {
            if (newRow == this.row - 2 && (newCol == this.col + 2 || newCol == this.col - 2)) {
